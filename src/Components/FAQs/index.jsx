    ...
    <>
      ...
      <Accordion allowMultiple w="60%" m="-3rem 0 9rem 15rem">
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              Yes. Then you can easily start shopping in our store. Just choose
              the product you like the most, add it to the cart and buy it by
              pressing the "Checkout" button and finally the "Buy" button.{" "}
              <br />
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              If you want to register on our website, click on "Log Up". <br />
              Enter your email and password. <br />
              Confirm your email and you're ready! <br />
              The next time you enter on Nøkler you'll be log in already, but in
              case you want to log out then you just will need to log in again,
              with the account registered previously.
            </Text>
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              Digital goods are the opposite of physical ones, meaning you can’t
              touch them. <br /> They are usually in the form of a code (a
              series of letters and digits, ABCD-1234-XY96 for example). <br />{" "}
              A code can be activated on various platforms and apps (like Steam)
              so you can easily download the content from there. This is a huge
              time-saver, since you don’t have to go to the store or wait for
              the delivery of the product. <br /> The code for the digital
              product you bought on Nøkler is sent to you via e-mail, so the
              process is almost instant.
            </Text>
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              ...
              Make sure that the game you are going to buy is from the platform
              you want. <br />
              Once you have chosen the game, click on "Add to cart". If you want
              to continue browsing press the "Continue Browsing" button or on
              "Checkout now!", this last button will take you immediately to the
              checkout section. <br />
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              The payment methods available on the checkout page are limited at
              the moment, we accept credit cards and debit cards as well. <br />
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              In case your transaction has been declined, please make sure that:{" "}
              <br />
              You have available balance <br />
              You have configured right your personal information in the
              checkout section. <br />
              If you checked these requirements and still have problems, please
        ...
        <AccordionItem>
          <h2>
            <AccordionButton>
              <Box flex="1" textAlign="left" fontSize={"x-large"}>
                I purchased a wrong product (wrong platform or multiple copies)
                What can I do?
              </Box>
              <AccordionIcon />
            </AccordionButton>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              Remember to always check the details of a game before purchasing.
              Anyways, in Nøkler you can refound your purchase in case you need
              to.
            </Text>
          </AccordionPanel>
        </AccordionItem>
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              ...
              marketplace ecosystem safe for everyone. This means that – in some
              rare situations – your account on Nøkler may be suspended due to
              security-related concerns. <br /> In order to make sure that this
              doesn't happen because of network connection security problems,
              please go through the following steps: <br /> Use your own,
              private Internet connection. <br /> Do not use public networks, as
              they are highly unsafe.
              <br /> Make sure that you aren't using any VPNs or proxy software.{" "}
              <br /> Try using your mobile Internet connection. <br /> Delete
              cookie files and clear the cache of your browser. <br /> If your
              account is still suspended even after following the instructions
        ...
        <AccordionItem>
          ...
          <AccordionPanel pb={4}>
            <Text color={"gray.500"}>
              ...
              section or you are experiencing problems, our Support is available
              24/7. Depending on your questions or the problems you are having,
              you can contact us{" "}
              <Link to="/contact">
                <strong>Here</strong>
              </Link>
