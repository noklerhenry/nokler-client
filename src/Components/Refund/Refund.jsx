...
import SubmittedRefund from "./SubmittedRefund";
  ...
  return (
    <>
      {!submitted ? (
            ...
            >
              <GridItem colSpan={{ md: 1 }}>
                <Box px={[4, 0]}>
                  ...
                  <Text mt={3}>
                    <Text>
                      The time it will take for you to receive your funds
                      depends on the type of payment method you used. Remember
                      that refunds have to go through a validation process
                      before being approved.
                    </Text>

                    <Text mt={3}>
                      For example, a payment made via the PayPal Wallet takes
                      just a few moments to go through, but if you paid using a
                      credit or debit card - it might take between a few days up
                      to 28 business days for your payment provider to process
                      your refund.
                    </Text>

                    <Text mt={3}>
                      You may contact your payment provider if you need more
                      information on the time they need to process your funds
                      back to you.
                    </Text>
                  </Text>
                </Box>
        ...
        <SubmittedRefund setSubmitted={setSubmitted} />
      )}
    </>
  );
}
